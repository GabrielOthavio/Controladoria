# Generated by Django 5.2 on 2025-10-01 02:48
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nome', models.CharField(help_text='Nome único para o grupo de índice.', max_length=150, unique=True, verbose_name='Nome do Grupo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_unico', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('nome_acao', models.CharField(max_length=255, unique=True, verbose_name='Nome da Ação')),
